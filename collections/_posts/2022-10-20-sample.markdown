...
## 구글 드라이브 동영상
```liquid
{% raw %}{% include video id="1hbD5Im1pNQBYfQdeDZId9QIyzw7WpM9T" provider="google-drive" %}{% endraw %}
```
{% include video id="1hbD5Im1pNQBYfQdeDZId9QIyzw7WpM9T" provider="google-drive" %}
